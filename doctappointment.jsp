...
<table border="2" bordercolor="#14569D">
<tr>
...
<td><font color="#14569D" size="4">TREATMENT</td>
</tr>
<% while(rs.next())
{%>
...
<td><a href="viewteethlocation.jsp?a=<%=rs.getString(9)%>s=<%=rs.getString(8)%>"><input type="button" value="TeethLocation" style="float: right;" class="button button2" ></a></td><%
String s1=request.getParameter("pat");
Cookie c=new Cookie("x",s1);
response.addCookie(c);
%>
<td><input type="submit" value="StartTreatment" style="background-color:#88D3ED;">
</tr>
<% }
%>
</table></center>
